...
function RunSim {
  ...
  echo '' > "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UlAvgResourceUtilizationPerRemoteUeInitXPos.txt"
  echo '' > "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgAppThroughputPerRemoteUeInitXPos.txt"
  echo '' > "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgDelayPerRemoteUeInitXPos.txt"

  remoteUeInitXPos=$remoteUeInitXPosStart
  while [  $remoteUeInitXPos -lt $remoteUeInitXPosEnd ]; do

    outputDir="output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_remoteUeInitXPos_${remoteUeInitXPos}"
    mkdir -p $outputDir
    cd $outputDir
    ...
    ../build/scratch/wns3-2019-relay-remote-ooc --useRelay=$useRelay --remoteUeInitXPos=$remoteUeInitXPos --relayUeInitXPos=$relayUeInitXPos
    #../build/scratch/wns3-2019-relay-remote-ooc --useRelay=$useRelay --remoteUeInitXPos=$remoteUeInitXPos --relayUeInitXPos=$relayUeInitXPos --RngRun=2
    ...
    do 
      ...
      awk -v remoteUeInitXPos=$remoteUeInitXPos -v upwTxNodeId=$upwTxNodeId '{print remoteUeInitXPos, upwTxNodeId, $0;}' "AppPacketTrace_Upward_TxNode_${upwTxNodeId}_ThroughputAverage.txt" >> "../output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgAppThroughputPerRemoteUeInitXPos.txt"
      ...
      awk -v remoteUeInitXPos=$remoteUeInitXPos -v upwTxNodeId=$upwTxNodeId '{print remoteUeInitXPos, upwTxNodeId, $0;}' "AppPacketTrace_Upward_TxNode_${upwTxNodeId}_RxPacketDelayAverage.txt" >> "../output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgDelayPerRemoteUeInitXPos.txt"
    ...
    then
      ...
      awk -v remoteUeInitXPos=$remoteUeInitXPos '{print remoteUeInitXPos, $0;}' UL_ResourceUtilizationOverTime_Average.txt >> "../output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UlAvgResourceUtilizationPerRemoteUeInitXPos.txt"
      ...
      echo -e "$remoteUeInitXPos\t0" >> "../output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UlAvgResourceUtilizationPerRemoteUeInitXPos.txt"
    fi
  ...
  for upwTxNodeId in $UpwTxNodeIds
  do 
    awk -v upwTxNodeId=$upwTxNodeId '{if ($2 == upwTxNodeId){print $0;}}' "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgAppThroughputPerRemoteUeInitXPos.txt" | sort -n > output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgAppThroughputPerRemoteUeInitXPos_${upwTxNodeId}.txt
  
    awk -v upwTxNodeId=$upwTxNodeId '{if ($2 == upwTxNodeId && $3 != 0){print $0;}}' "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgDelayPerRemoteUeInitXPos.txt" > "output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgDelayPerRemoteUeInitXPos_${upwTxNodeId}.txt"
...
do
    ...
    UlStringToPlotResUtil="$UlStringToPlotResUtil \"output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UlAvgResourceUtilizationPerRemoteUeInitXPos.txt\" using 1:(100*\$2):3 with yerr title \"${legend}\", '' using 1:(100*\$2) with lines lc $linecolor notitle,"
    UwdStringToPlotAvgTput="$UwdStringToPlotAvgTput \"output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgAppThroughputPerRemoteUeInitXPos_${upwTxNodeId}.txt\" using 1:3:4 with yerr title \"${legend}\", '' using 1:3 with lines lc $linecolor notitle,"
    UwdStringToPlotAvgDelay="$UwdStringToPlotAvgDelay \"output_wns3-2019-relay-remote-ooc_useRelay_${useRelay}_UpwardAvgDelayPerRemoteUeInitXPos_${upwTxNodeId}.txt\" using 1:3:4 with yerr title \"${legend}\", '' using 1:3 with lines lc $linecolor notitle,"
...
echo "reset 
      set terminal pngcairo nocrop enhanced size 800,600
      set output \"output_wns3-2019-relay-remote-ooc_UL_ResourceUtilizationPerRemoteUeInitXPos.png\"
...
echo "reset 
      set terminal pngcairo nocrop enhanced size 800,600
      set output \"output_wns3-2019-relay-remote-ooc_Upward_ThroughputPerRemoteUeInitXPos.png\"
      #set terminal postscript eps enhanced color font 'Helvetica,20'
...
echo "reset 
      set terminal pngcairo nocrop enhanced size 800,600
      set output \"output_wns3-2019-relay-remote-ooc_Upward_DelayPerRemoteUeInitXPos.png\"
      #set terminal postscript eps enhanced color font 'Helvetica,20'
