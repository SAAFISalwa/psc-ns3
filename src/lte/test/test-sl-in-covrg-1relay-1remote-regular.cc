...
{
  // LogComponentEnable ("TestSlInCovrg1Relay1RemoteRegular", LOG_LEVEL_ALL);

  //Test regular scenario
  //Remote UE detects, connects, and use relay UE to send and receive traffic (e.g. wns3-2019 type of scenario).
