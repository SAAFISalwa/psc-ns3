...
SlOocRelayGenericTrafficRm2RhTestCase::DoRun (void)
{
   ...
   * Each Remote UE starts sending traffic 1.00 s after the start of the
  ...
  NS_LOG_INFO ("Ratio of Remote UEs with traffic: " << nRemoteFlows << " / " << m_nRelayUes * m_nRemoteUesPerRelay << " = " << nRemoteFlows / (m_nRelayUes * m_nRemoteUesPerRelay));
  NS_LOG_INFO ("Ratio of Remote UEs with enough packets: " << nRemoteFlowsWithEnoughPackets << " / " << m_nRelayUes * m_nRemoteUesPerRelay << " = " << nRemoteFlowsWithEnoughPackets / (m_nRelayUes * m_nRemoteUesPerRelay));
