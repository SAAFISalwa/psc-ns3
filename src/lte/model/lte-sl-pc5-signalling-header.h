...
/**
 * This class has the purpose to encode Information Elements of PC5 signalling 
 * messages, as defined in 3GPP TS 24.334 V15.0.0 (2017-09).
*/
...
public:
  ...
  */
  ...
  /**
   * The different types of PC5 signalling messages
   */
...
/**
 * \ingroup nist
 * \brief sequence number for PC5 signalling headers
 *
...
/**
 * \ingroup nist
 * \brief Brief headers for PC5 signalling messages
 *
...
public:
  ...
  * Default constructor
   ...
   */
   void SetParameters (uint8_t userInfoType, std::vector<uint8_t> userInfo, uint8_t ipAddressConfig, uint32_t maxInactivityPeriod, std::vector<uint8_t> nonce1, uint16_t ueSecurityCapabilities, uint8_t msb, int32_t kdId, uint32_t relayServiceCode, std::vector<uint8_t> signature, std::vector<uint8_t> linkLocalIpv6Address);
    ...
    */
   void SetUserInfo (uint8_t userInfoType, std::vector<uint8_t> userInfo);
    ...
    */
   std::vector<uint8_t> GetUserInfo ();
...
public:
 ...
 /**
   ...
   */
   void SetParameters (uint16_t ueSecurityCapabilities, std::vector<uint8_t> nonce2, uint8_t chosenAlgorithmsIntegrity, uint8_t chosenAlgorithmCyphering, uint8_t lsb, uint16_t msb, std::vector<uint8_t> kdFreshness, std::vector<uint8_t> gpi,  uint8_t userInfoType, std::vector<uint8_t> userInfo, std::vector<uint8_t> signature, std::vector<uint8_t> encryptedPayload);
