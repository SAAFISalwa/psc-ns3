              ...
              if (tbPerKtrpVector[i] > 0)
                {
                  ...
                  {
                      std::cout<< "MCS:" << (uint16_t) ktrpMcsPrbInfoPair.second[vi].mcs << ", nbRB:" << (uint16_t) ktrpMcsPrbInfoPair.second[vi].nbRb << std::endl;
                  }*/
                      ...
                      for (std::vector <LteAmc::McsPrbInfo>::iterator itVector = (*itPair).second.begin (); itVector != (*itPair).second.end (); itVector++)
                        {
                          ...
                          //std::cout<< "MCS: " << (uint16_t) (*itVector).mcs << ", PRB: " << (uint16_t) (*itVector).nbRb <<", SINR: " << sinrFromBler << ", Dscore: " << pairScore <<std::endl;
