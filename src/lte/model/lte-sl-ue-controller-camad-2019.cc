...
LteSlUeControllerCamad2019::GetTypeId ()
{
  static TypeId tid = TypeId ("ns3::LteSlUeControllerCamad2019")
    ...
    .AddTraceSource ("DiscoversAllRelays",
                     ...
                     "ns3::LteSlUeControllerDiscovery::DiscoveryEventTracedCallback")
    ...
    .AddTraceSource ("RemoteConnectionStart",
                     ...
                     "ns3::LteSlUeControllerConnectionTime::RemoteConnectionStartTracedCallback")
    .AddTraceSource ("RemoteConnectionEstablished",
                     ...
                     "ns3::LteSlUeControllerConnectionTime::RemoteConnectionEstablishedTracedCallback")
  ;
  return tid;
}
...
void LteSlUeControllerCamad2019::RecvRelayServiceDiscovery (uint32_t serviceCode, uint64_t announcerInfo, uint32_t proseRelayUeId, uint8_t statusIndicator)
{
              ...
              if (m_campaign.compare ("Connection") == 0)
                {
                  ...
                  m_connectionCount++;
                  m_traceRemoteConnectionStart (m_slUeRrc->GetSourceL2Id (), proseRelayUeId, m_connectionCount);
                }
...
void LteSlUeControllerCamad2019::Pc5SecuredEstablished (uint32_t peerUeId, uint32_t selfUeId, LteSlUeRrc::RelayRole role)
{
...
void
LteSlUeControllerCamad2019::Pc5ConnectionTerminated (uint32_t peerUeId, uint32_t selfUeId, LteSlUeRrc::RelayRole role)
{
  NS_LOG_FUNCTION (this << peerUeId << selfUeId << role);
...
void
LteSlUeControllerCamad2019::Pc5ConnectionAborted (uint32_t peerUeId, uint32_t selfUeId, LteSlUeRrc::RelayRole role, LteSlO2oCommParams::UeO2ORejectReason reason)
{
...
void
LteSlUeControllerCamad2019::RecvRemoteUeReport (uint64_t localImsi, uint32_t peerUeId, uint64_t remoteImsi)
{
